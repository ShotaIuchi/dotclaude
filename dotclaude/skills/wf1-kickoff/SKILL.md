...
```
Creating local workflow.
Would you also like to create in external system?

1. Local only (can promote later with /wf0-promote)
2. Create GitHub Issue as well
3. Create Jira ticket as well
```
