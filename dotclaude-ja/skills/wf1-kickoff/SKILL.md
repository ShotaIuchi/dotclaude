...
新しいワークフローのワークスペースを初期化する。全wf1〜wf5ワークフローのエントリーポイント。
...
3. ユーザーに通知: キックオフ完了、`/wf2-spec <work-id>` で次に進めることを伝える

## 重要な注意事項

- テンプレートはこのスキルの `skills/wf1-kickoff/templates/01_KICKOFF.md` に同梱されている。
